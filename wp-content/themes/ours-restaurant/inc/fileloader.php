...
require get_template_directory() . '/inc/ample-themes/widgets/our-services.php';
require get_template_directory() . '/inc/ample-themes/widgets/about.php';
require get_template_directory() . '/inc/ample-themes/widgets/contact-us-widgets.php';
require get_template_directory() . '/inc/ample-themes/widgets/menu-and-room-list.php';
