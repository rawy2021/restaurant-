<?php
/**
 * Prestro Theme Customizer
 *
 * @package Prestro
 */

if ( ! class_exists( 'Prestro_Theme_Info' ) ) :

	/**
	 * Prestro_Theme_Info class.
	 */
	class Prestro_Theme_Info extends WP_Customize_Control {
		 ...
		 */
		public $type = 'prestro-themeinfo-control';
		...
		/**
		 * Prestro_Theme_Info constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Prestro_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'prestro-style', get_template_directory_uri() . '/inc/css/prestro-style.css', '1.0.0' );
		}
		...
		public function content_template() {
			?>
			<div class="prestro-themeinfo">
				<# if ( data.options ) { #>
					<ul class="prestro-themeinfo-features">
						...
						<# if ( data.button_text && data.button_url ) { #>
							...
							<# } #>
								...
								<# if ( data.explained_features.length > 0 ) { #>
									...
									<ul class="prestro-themeinfo-feature-list">
